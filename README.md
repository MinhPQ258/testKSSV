...
| Quy tắc | Cài đặt |
|---|---|
| ⚠ Cờ rủi ro | **ĐÃ ĐẢO NGƯỢC BR-506** theo chốt nghiệp vụ 23/09/2026: cờ rủi ro **chỉ phụ thuộc ô tích của CBBH**. Các kết quả kiểm tra (Sai mục đích, Vi phạm, HĐKD/TSBĐ rủi ro) **không còn tự suy ra** rủi ro. Hệ thống cũng **không gợi ý, không cảnh báo** gì dựa trên kết quả kiểm tra — toàn bộ việc đánh giá do cán bộ tự tích thủ công. Cần cập nhật lại BR-506 trong URD trước khi làm FSD |
